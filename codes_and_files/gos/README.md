...
####  &nbsp; &nbsp; &nbsp; cond_prob: the conditional probability given that all of the parents are all in the same gene annotations, the probability that this GO-term itself also is in the same gene annotations. <br /> 
